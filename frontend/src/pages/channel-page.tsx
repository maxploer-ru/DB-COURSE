...
export function ChannelPage() {
  ...
  const [videoSort, setVideoSort] = useState<'newest' | 'views' | 'rating'>('newest')
  ...
  const videosQuery = useQuery({
    queryKey: ['channel-videos', parsedChannelId, videoSort],
    queryFn: () => videoApi.listByChannel(parsedChannelId, { limit: 50, offset: 0, sort: videoSort }),
    enabled: Number.isFinite(parsedChannelId),
  })
  ...
  return (
    <section className="page">
      ...
      <div className="comments__actions">
        <button
          className={videoSort === 'newest' ? 'app-button' : 'app-button app-button--ghost'}
          type="button"
        ...
        <button
          className={videoSort === 'views' ? 'app-button' : 'app-button app-button--ghost'}
          type="button"
        ...
        <button
          className={videoSort === 'rating' ? 'app-button' : 'app-button app-button--ghost'}
          type="button"
