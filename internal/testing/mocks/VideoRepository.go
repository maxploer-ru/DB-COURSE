...
func (_m *VideoRepository) Count(ctx context.Context) (int64, error) {
	ret := _m.Called(ctx)
...
func (_m *VideoRepository) CountByChannel(ctx context.Context, channelID int) (int64, error) {
...
func (_m *VideoRepository) List(ctx context.Context, limit int, offset int) ([]*domain.Video, error) {
...
func (_m *VideoRepository) ListByChannel(ctx context.Context, channelID int, limit int, offset int) ([]*domain.Video, error) {
