...
func (_m *UserRepository) CountUsers(ctx context.Context) (int64, error) {
	ret := _m.Called(ctx)
...
func (_m *UserRepository) GetByIDs(ctx context.Context, ids []int) ([]*domain.User, error) {
...
func (_m *UserRepository) ListUsers(ctx context.Context, limit int, offset int) ([]*domain.User, error) {
